...
@Service
public class EntrepreneurAccountingRecordShowService implements AbstractShowService<Administrator, Customization> {

	@Autowired
	private EntrepreneurAccountingRecordRepositoryry repository;
